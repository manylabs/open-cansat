...
class SFE_BMP180
{
	...
	private:
		...
		char readInt(char address, int16_t &value);
			// read an signed int16_t (16 bits) from a BMP180 register
			// address: BMP180 register address
			// value: external signed int16_t for returned value (16 bits)
			// returns 1 for success, 0 for fail, with result in value

		char readUInt(char address, uint16_t &value);
			// read an uint16_t (16 bits) from a BMP180 register
			// address: BMP180 register address
			// value: external uint16_t for returned value (16 bits)
			// returns 1 for success, 0 for fail, with result in value
